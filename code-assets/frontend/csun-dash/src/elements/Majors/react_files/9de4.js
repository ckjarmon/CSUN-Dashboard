                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%', outlineStyle: "solid", outlineColor: "red", borderRadius: "25px" }}>
                        <Box color="white" bgcolor="#000000" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.A., Cinema and Television Arts: Screenwriting</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>All lower and upper division courses taken toward completion of the CTVA major must be completed with a grade of C or better. In addition, students intending to continue in the Screenwriting option must pass CTVA 220 with a grade of B- or better.</li>
</ul>
...
<li>Select one of the following production courses:</li>
...
<li>*Note: Students intending to continue in the Screenwriting option must pass CTVA 220 with a grade of B- or better.</li>
</ul>
...
<div style={redBoldStyle}>3. Screenwriting Option (21 units)</div>
<ul style={list_style}>
<li>Screenwriting Core Requirements (12 units):</li>
<li>CTVA 309 Film as Literature (3)</li>
<li>CTVA 320 Writing for Film and Television (3)</li>
<li>CTVA 420 Screenplay Adaptation (3)</li>
<li>CTVA 425 Advanced Screenwriting (3)</li>
<li>Select one of the following courses (3 units):</li>
...
<li>CTVA 428 Writing Screenplay Comedy (3)</li>
<li>Additional Units (3 units)</li>
<li>Select 3 additional units in CTVA or an allied field, with the approval of an advisor, as prescribed in the official departmental advisement form for Screenwriting.</li>
</ul>
...
<li>6 units are satisfied by the following courses in the major: CTVA 309 satisfies upper division C1 Arts; and CTVA 100 satisfies E Lifelong Learning and fulfills the Information Competence requirement.</li>
</ul>
