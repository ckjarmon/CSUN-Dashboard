                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%', outlineStyle: "solid", outlineColor: "red", borderRadius: "25px" }}>
                        <Box color="white" bgcolor="#000000" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Kinesiology: Physical Education</h2><div style={titleStyle}>Program Requirements</div><div style={redBoldStyle}>A. Lower Division Prerequisite Courses (20-26 units)</div>
<ul style={list_style}>
</ul>
...
<li>Choose one course from the following courses:</li>
<li>KIN 130A-133A, 151A Martial Arts Course (1)</li>
<li>Take the following courses:</li>
<li>KIN 242 Movement Forms: Basic Dance (1)</li>
<li>KIN 250SW Professional Activities: Swimming (1)</li>
</ul>
...
<div style={redBoldStyle}>C. Physical Education Option Requirements (32 units)</div>
<ul style={list_style}>
</ul>
<div style={redBoldStyle}>1. Lower Division Required Courses (9 units)</div>
<ul style={list_style}>
<li>KIN 271/L Fundamental Movement, Gymnastics and Rhythms and Lab (2/1)</li>
<li>KIN 272/L Nontraditional Games and Activities and Lab (2/1)</li>
<li>KIN 273/L Analysis and Application of Games and Sport and Lab (2/1)</li>
</ul>
...
<li>KIN 335/L Health-Related Fitness in K-12 Physical Education and Lab (2/1)</li>
<li>KIN 347 Introduction to Adapted Physical Education (3)</li>
<li>KIN 371/L Physical Education Content Development for Children and Lab (2/1)</li>
<li>KIN 462/L Physical Education Content Development for Adolescents and Lab (2/1)</li>
<li>KIN 472/L Learner Assessment and Technology in K-12 Physical Education and Lab (2/1)</li>
...
<li>If taken, KIN 130A, KIN 131A, KIN 132A or KIN 133A satisfies 1 unit of E Lifelong Learning.</li>
</ul>
<br></br><ul style={summary_style}>
<li>Total Units in the Major/Option: 73-79</li>
<li>General Education Units: 36</li>
<li>Additional Units: 5-11</li>
