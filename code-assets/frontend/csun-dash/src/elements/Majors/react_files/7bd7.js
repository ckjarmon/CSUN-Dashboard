                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.A., Cinema and Television Arts: Entertainment Media Management</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>All lower and upper division courses taken toward completion of the CTVA major must be completed with a grade of C or better.</li>
</ul>
...
<li>Select one of the following courses* (3 units):</li>
<li>*Students in the Entertainment Media Management option must select from either CTVA 351 or CTVA 482 to fulfill the upper division common core requirement in Entertainment Management.</li>
...
<div style={redBoldStyle}>3. Entertainment Media Management Option (21 units)</div>
<ul style={list_style}>
<li>Entertainment Media Management Core Requirements (15 units)</li>
<li>CTVA 301 Media Research Methods (3)</li>
<li>CTVA 475 Audience Analysis (3)</li>
<li>CTVA 480 Electronic Media Management (3)</li>
<li>CTVA 487 Social Controls and Regulation of Electronic Media (3)</li>
<li>CTVA 489 Strategic Media Management (3)</li>
<li>Select two of the following courses (6 units):</li>
<li>CTVA 384 Electronic Media Advertising (3)</li>
<li>CTVA 405 International Broadcasting (3)</li>
<li>CTVA 467 The Management of Postproduction for Television and Film (3)</li>
<li>CTVA 481 Network Practices (3)</li>
<li>CTVA 483 Emerging Media Programming and Practices (3)</li>
</ul>
