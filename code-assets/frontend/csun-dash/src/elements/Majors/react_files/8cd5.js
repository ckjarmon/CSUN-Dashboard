                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.A., Religious Studies</h2><div style={titleStyle}>Program Requirements</div><div style={redBoldStyle}>1. Lower Division Required Courses (6 units)</div>
<ul style={list_style}>
...
<div style={redBoldStyle}>2. Upper Division (36 units)</div>
<ul style={list_style}>
</ul>
...
<div style={redBoldStyle}>4. Proseminar (3 units)</div>
<ul style={list_style}>
<li>RS 497B Proseminar in Religious Studies (3 units)</li>
</ul>
