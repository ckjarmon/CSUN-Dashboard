                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.A., Spanish: Language and Culture</h2><div style={titleStyle}>Program Requirements</div><div style={redBoldStyle}>1. Core Courses Common to All Options (24 units)</div>
<ul style={list_style}>
...
<div style={redBoldStyle}>2. Language and Culture Option Courses (18 units)</div>
<ul style={list_style}>
<li>Choose one course from the following (3 units):</li>
<li>SPAN 300 Advanced Conversational Spanish (3)</li>
<li>SPAN 310 Language and Contemporary Hispanic Life (3)</li>
<li>Choose three courses from the following (9 units):</li>
...
<li>Choose one course from the following (3 units):</li>
<li>SPAN 382 Literature and Society in Latin America (3)</li>
<li>SPAN 383 Literature and Society in Spain (3)</li>
<li>Take the following course (3 units):</li>
