                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%', outlineStyle: "solid", outlineColor: "red", borderRadius: "25px" }}>
                        <Box color="white" bgcolor="#000000" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Civil Engineering</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>The Civil Engineering program expects an adequate high school preparation in science, mathematics and English. High school courses should include algebra, plane geometry, trigonometry and chemistry or physics (both desirable), and four years of English.</li>
...
<li>The Mathematics Placement Test (MPT) is required prior to enrollment in MATH 150A. Students should take this exam prior to enrolling in their classes so they may be placed in the appropriate mathematics course. Students with scores of 4 or 5 on the AP Calculus AB or BC exams are exempt from the MPT.</li>
...
<li>CE 101/L Introduction to Civil Engineering and Lab (1/1)</li>
...
<li>CE 280/L Computer Applications in Civil Engineering and Lab (1/1)</li>
...
<div style={redBoldStyle}>2. Upper Division Required Courses (54 units)</div>
<ul style={list_style}>
<li>Junior Year</li>
<li>AM 316 Engineering Dynamics (3)</li>
<li>AM 317 Mechanics Lab (1)</li>
<li>CE 308/L Surveying and Lab (2/1)</li>
<li>CE 315/L Construction Engineering and Lab (2/1)</li>
<li>CE 335/L Structures I and Lab (3/1)</li>
<li>CE 340 Strength of Materials (3)</li>
<li>CE 408/L Surveying with GPS Applications and Lab (1/1)</li>
...
<li>CE 426/L Soil Mechanics and Lab (3/1)</li>
<li>CE 438 Reinforced Concrete Design (3)</li>
<li>CE 439 Structural Steel Design (3)</li>
<li>CE 460/L Engineering Hydrology and Lab (2/1)</li>
<li>CE 488A/L Civil Engineering Senior Design I and Lab (1/1)</li>
<li>CE 488B Civil Engineering Senior Design II (2)</li>
<li>CE 526 Geotechnical Foundation Design (3)</li>
<li>ME 493 Hydraulics (3)</li>
</ul>
...
<li>22 units are satisfied by coursework in the major. Completion of the Civil Engineering major satisfies A3 Critical Thinking. PHYS 220A satisfies B1 Physical Science; BIOL 106 satisfies B2 Life Science; PHYS 220AL satisfies B3 Science Laboratory Activity; MATH 150A satisfies Basic Skills B4 Mathematics/Quantitative Reasoning; ME 370 satisfies B5 Scientific Inquiry and Quantitative Reasoning; 1 unit of C1 Arts or C2 Humanities is waived; MSE 304 satisfies 3 units of upper division D1 Social Sciences; and CE 101/L and CE 280/L satisfy E Lifelong Learning.</li>
</ul>
<br></br><ul style={summary_style}>
<li>Total Units in the Major: 100</li>
<li>General Education Units: 26</li>
