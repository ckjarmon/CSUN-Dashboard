                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Geography and Environmental Studies</h2><div style={titleStyle}>Program Requirements</div><div style={redBoldStyle}>1. Lower Division Courses (6-7 units)</div>
<ul style={list_style}>
...
<div style={redBoldStyle}>2. Upper Division Courses (42 units)</div>
<ul style={list_style}>
</ul>
...
<ul style={sublist_style}>
<li>Select one course from the following:</li>
<li>GEOG 404A-Z Field Studies in Geography (1-3)</li>
</ul>
<div style={subRedBoldStyle}>c. Content Courses (6 units)</div>
<ul style={sublist_style}>
...
<div style={subRedBoldStyle}>d. Method Courses (9 units)</div>
<ul style={sublist_style}>
...
<li>GEOG 304/L Map and Imagery Interpretation and Lab (2/1)</li>
<li>GEOG 305/L Maps and Graphics and Lab (2/1)</li>
<li>GEOG 306/L Intermediate Geographical Information Science and Lab (2/1)</li>
<li>GEOG 449 Mixed Methods for Human and Environmental Geography (3)</li>
<li>GEOG 460/L Introduction to Spatial Analysis and Comparison and Lab (2/1)</li>
</ul>
<div style={subRedBoldStyle}>e. Regional Course (3 units)</div>
<ul style={sublist_style}>
<li>Select one course from the following:</li>
<li>GEOG 318 Europe (3)</li>
<li>GEOG 321 United States (3)</li>
<li>GEOG 322 Latin America (3)</li>
<li>GEOG 323 Canada (3)</li>
<li>GEOG 324 China (3)</li>
<li>GEOG 326 Africa (3)</li>
<li>GEOG 328 Mexico (3)</li>
<li>GEOG 330 California (3)</li>
<li>GEOG 334 Geography of Oceania (3)</li>
<li>GEOG 350 Metropolitan Los Angeles (3)</li>
</ul>
<div style={subRedBoldStyle}>f. Application Courses (6 units)</div>
<ul style={sublist_style}>
<li>Select two courses from the following:</li>
<li>GEOG 402/L Physical Geography Techniques and Lab (2/1)</li>
<li>GEOG 406/L Advanced Geographical Information Science and Lab (2/1)</li>
<li>GEOG 408A/L Human/Cultural Applications in Geographical Information Science and Lab (2/1)</li>
<li>GEOG 408B/L Environmental/Physical Applications in Geographical Information Science and Lab (2/1)</li>
...
<li>GEOG 409/L Digital Cartography and Lab (2/1)</li>
<li>GEOG 411 World Climate (3)</li>
<li>GEOG 412 Boundary Layer Climatology (3)</li>
<li>GEOG 413 Bioclimatology (3)</li>
<li>GEOG 414 Hydroclimatology (3)</li>
<li>GEOG 415 Air Pollution (3)</li>
<li>GEOG 416 Earth's Changing Climate (3)</li>
<li>GEOG 444 Conservation (3)</li>
<li>GEOG 451 Advanced Urban Geography (3)</li>
<li>GEOG 452 Urban Land Use Planning (3)</li>
<li>GEOG 453 Housing and Community Development (3)</li>
<li>GEOG 459 Environmental Impact Studies (3)</li>
<li>GEOG 460/L Spatial Analysis and Comparison and Lab (2/1)</li>
<li>GEOG 462/L Computer Applications in Geography and Lab (2/1)</li>
<li>GEOG 465/L Fluvial Geomorphology and Lab (2/1)</li>
<li>GEOG 466/L Glacial and Periglacial Geomorphology and Lab (2/1)</li>
<li>GEOG 467/L Arid Lands Geomorphology and Lab (2/1)</li>
<li>GEOG 468/L Coastal Geomorphology and Lab (2/1)</li>
<li>GEOG 470 The Geography of Aquatic Ecosystems (3)</li>
<li>GEOG 472 Water Transfers in the American West (3)</li>
<li>GEOG 473 Water Quality in the Managed Environment (3)</li>
<li>GEOG 474 Water in Dryland Environments (3)</li>
<li>GEOG 476 Principles of River Restoration (3)</li>
<li>GEOG 482 Population, Migration, and the Environment (3)</li>
<li>GEOG 483 Transportation Planning (3)</li>
<li>GEOG 486 Medical Geography (3)</li>
<li>GEOG 487 Geography of Popular Culture (3)</li>
...
<div style={subRedBoldStyle}>h. Elective Courses (9 units)</div>
<ul style={sublist_style}>
<li>Take three additional upper division (300-, 400- or 500-level) Geography courses.</li>
</ul>
...
<li>3 units are satisfied by the following courses in the major: GEOG 101A or GEOG 103A satisfies B1 Physical Science; GEOG 101AL or GEOG 103AL satisfies B3 Science Laboratory Activity.</li>
<li>If taken, GEOG 311, GEOG 316, GEOG 365 or GEOG 366 satisfies B5 Scientific Inquiry and Quantitative Reasoning; GEOG 107, GEOG 150, GEOG 170, GEOG 301, GEOG 321, GEOG 330, GEOG 351 and/or GEOG 370 satisfies 3-6 units of D1 Social Sciences; GEOG 206/L satisfies E Lifelong Learning; and GEOG 318, GEOG 322, GEOG 324, GEOG 326 or GEOG 334 satisfies 3 units of upper division F Comparative Cultural Studies. (GEOG 206/L or GEOG 365 also fulfills the Information Competence requirement.)</li>
</ul>
<br></br><ul style={summary_style}>
<li>Total Units in the Major/Option: 48-49</li>
<li>General Education Units: 45</li>
<li>Additional Units: 26-27</li>
