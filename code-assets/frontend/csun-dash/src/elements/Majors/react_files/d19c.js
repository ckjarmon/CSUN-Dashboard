...
<div style={redBoldStyle}>2. Upper Division Required Courses (41 units)</div>
<ul style={list_style}>
<li>ASTR 300 Introductory Astrophysics (3)</li>
...
<div style={redBoldStyle}>3. Upper Division Elective (3 units)</div>
<ul style={list_style}>
<li>Choose 3 units from the following:</li>
