                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Business Administration: Risk Management and Insurance</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>Admission to the BSBA Option in Risk Management and Insurance</li>
<li>The BSBA option in Risk Management and Insurance is an impacted program. Students seeking an option in Risk Management and Insurance may initially declare an option in Pre-Finance while working to satisfy supplemental criteria, which requires completion of at least 60 units and a minimum cumulative GPA of 2.6. Students must qualify by the time they earn 90 units. Additionally, a grade of C or higher in FIN 303 is a prerequisite for all 400-level Finance (FIN) courses and selected 300-level Finance courses.</li>
...
<div style={redBoldStyle}>3. Finance Core (6 units)</div>
<ul style={list_style}>
<li>FIN 352 Investment Management (3)</li>
...
<div style={redBoldStyle}>4. Risk Management and Insurance Option (18 units)</div>
<ul style={list_style}>
<li>Required Courses (15 units)</li>
<li>FIN 336 Principles of Risk Management and Insurance (3)</li>
<li>FIN 355 Corporate Finance (3)</li>
<li>FIN 431 Risk Management (3)</li>
<li>FIN 434 Life and Health Insurance (3)</li>
<li>FIN 495A-C Seminar in Insurance (3)</li>
<li>Elective (3 units)</li>
<li>Select 3 units of Finance elective courses (does not include FIN 102, 338, 433 or 439; may not double count toward the Financial Planning option; FIN 302 can be double counted toward GE).</li>
<li>May include 3 units from the following:</li>
...
<li>ECON 409 Introduction to Econometrics (3)***</li>
<li>***ACCT 440, ACCT 450 and ECON 409 have additional prerequisites beyond the required courses shown above.</li>
</ul>
...
<li>If taken, ECON 310 satisfies upper division D1 Social Sciences.</li>
</ul>
