                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.A., Cinema and Television Arts: Media Theory and Criticism</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>All lower and upper division courses taken toward completion of the CTVA major must be completed with a grade of C or better.</li>
</ul>
...
<div style={redBoldStyle}>3. Media Theory and Criticism Option (21 units)</div>
<ul style={list_style}>
<li>Media Theory and Criticism Upper Division Core Requirements (9 units)</li>
<li>CTVA 301 Media Research Methods (3)</li>
<li>CTVA 311 History of Global Cinema (3)</li>
<li>CTVA 410 Advanced Theory in CTVA (3)</li>
<li>Select four of the following courses (12 units):</li>
<li>CTVA 305 History of Television (3)*</li>
<li>CTVA 309 Film as Literature (3)</li>
<li>CTVA 315 New Directions in Electronic Media Systems (3)</li>
<li>CTVA 400 Mass Media and Society (3)</li>
<li>CTVA 411A-Z Genres in Cinema and Television Arts (3)</li>
<li>CTVA 412 Analysis of Classic Filmmakers (3)</li>
<li>CTVA 413 Women as Filmmakers (3)</li>
<li>CTVA 415A-Z Regional and National Cinemas (3)</li>
<li>CTVA 416 The Documentary Tradition in Film and Video (3)</li>
<li>*If not taken to satisfy the upper division common core history requirement.</li>
</ul>
...
<li>If taken, CTVA 309 satisfies upper division C1 Arts.</li>
</ul>
