                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%', outlineStyle: "solid", outlineColor: "red", borderRadius: "25px" }}>
                        <Box color="white" bgcolor="#000000" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Information Systems: Business Systems</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>Business Majors</li>
...
<div style={redBoldStyle}>4. Business Systems (IS-BS) Option (18 units)</div>
<ul style={list_style}>
<li>IS-BS provides a diverse array of business and information systems electives for analyst and compliance/governance/audit type of positions.</li>
<li>IS 335 Building Enterprise Architecture (3)</li>
<li>IS 355 Application Development (3)</li>
<li>Select 12 units from the following elective courses:</li>
<li>IS 457 Advanced Telecommunications and Networking (3)</li>
<li>IS 497A-Z Special Topics—Information Systems (3)</li>
<li>IS 498C Field Assignments and Reports Information Systems (3)</li>
<li>IS 499C Independent Study (3)</li>
<li>SOM 485 Decision Support Systems (3)</li>
</ul>
...
<li>Total Units in the Major/Option: 83</li>
<li>General Education Units: 33</li>
<li>Additional Units: 4</li>
