                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%', outlineStyle: "solid", outlineColor: "red", borderRadius: "25px" }}>
                        <Box color="white" bgcolor="#000000" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.A., Physics</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>To enroll in the first courses in Mathematics and Chemistry, students must obtain a satisfactory score on the Mathematics Placement Test (MPT) and the Chemistry Placement Test (CPT). Without a satisfactory score, students may be required to take additional courses in preparation for the required courses. Students must complete the course requirements listed. In addition, all students are required to take two comprehensive exams—one on general physics upon completion of PHYS 227 or its equivalent and one on advanced physics just before graduation. The dates of these exams will be posted in the department office. Finally, students are required to do a senior project in their final year and pass the associated class PHYS 497. For more information, consult the department undergraduate advisor.</li>
</ul>
...
<ul style={list_style}>
<li>Electives should be chosen with approval of the department undergraduate advisor. Note: Upper division courses in the major plus upper division courses outside the major must total a minimum of 40 units in accordance with University requirements for a B.A. degree.</li>
</ul>
...
<li>Total Units in the Major: 64</li>
<li>General Education Units: 39</li>
<li>Additional Units: 17</li>
