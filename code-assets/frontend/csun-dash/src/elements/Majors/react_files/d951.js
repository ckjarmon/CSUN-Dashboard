                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Information Systems: Software Technology</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>Business Majors</li>
...
<ul style={list_style}>
<li>COMP 110/L Introduction to Algorithms and Programming/Lab (3/1)</li>
...
<div style={redBoldStyle}>4. Software Technology (IS-ST) Option (20 units)</div>
<ul style={list_style}>
<li>IS-ST provides a focus of software development electives for positions in software development for business.</li>
<li>COMP 122/L Computer Architecture and Assembly Language (1/1)</li>
...
<li>Select 5 units from the following courses:</li>
<li>COMP 424 Computer System Security (3)</li>
<li>COMP 467 Multimedia Systems Design (3)</li>
<li>COMP 484/L Web Engineering I and Lab (2/1)</li>
<li>COMP 485 Human-Computer Interaction (3)</li>
<li>COMP 541 Data Mining (3)</li>
<li>IS 498B Field Assignments and Reports Information Systems (2)</li>
<li>IS 499B Independent Study (2)</li>
</ul>
