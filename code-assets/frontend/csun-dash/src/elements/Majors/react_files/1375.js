                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Information Systems: Health Systems</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>Business Majors</li>
...
<div style={redBoldStyle}>4. Health Systems (IS-HS) Option (18 units)</div>
<ul style={list_style}>
<li>IS-HS provides a focus of health informatics electives for IT positions in the healthcare industry.</li>
<li>IS 335 Information Technology in Business (3)</li>
...
<li>HSCI 391 Computer Application in Health Sciences (3)</li>
...
<li>*Prerequisite of HSCI 312 is waived.</li>
</ul>
