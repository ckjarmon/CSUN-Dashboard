                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%', outlineStyle: "solid", outlineColor: "red", borderRadius: "25px" }}>
                        <Box color="white" bgcolor="#000000" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Mathematics: Mathematics</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>Requirements</li>
...
<li>Students must complete the lower division core and one of the following Mathematics options, and they must have at least a 2.0 GPA for all upper division units required in the major.</li>
</ul>
...
<div style={redBoldStyle}>3. Upper Division Electives (15 units)</div>
<ul style={list_style}>
<li>Students must take five elective courses chosen with an advisor from the following list, including at least one from MATH 450B and MATH 460.</li>
<li>MATH 366 Combinatorics (3)</li>
<li>MATH 440A Mathematical Statistics I (3)</li>
<li>MATH 440B Mathematical Statistics II (3)</li>
<li>MATH 450B Advanced Calculus II (3)</li>
<li>MATH 455 Complex Variables (3)</li>
<li>MATH 460 Abstract Algebra II (3)</li>
<li>MATH 463 Number Theory (3)</li>
<li>MATH 480 Partial Differential Equations (3)</li>
<li>MATH 481A Numerical Analysis (3)</li>
<li>MATH 481B Numerical Analysis (3)</li>
<li>MATH 481C Numerical Methods for Partial Differential Equations (3)</li>
<li>MATH 481D Topics in Numerical Mathematics (3)</li>
<li>MATH 483 Mathematical Modeling (3)</li>
<li>All 500-level Math courses, except those numbered MATH 510-514.</li>
</ul>
