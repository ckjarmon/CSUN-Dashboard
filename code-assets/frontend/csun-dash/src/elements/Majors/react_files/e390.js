                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%', outlineStyle: "solid", outlineColor: "red", borderRadius: "25px" }}>
                        <Box color="white" bgcolor="#000000" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Kinesiology: Exercise Science</h2><div style={titleStyle}>Program Requirements</div><div style={redBoldStyle}>A. Lower Division Prerequisite Courses (20-26 units)</div>
<ul style={list_style}>
</ul>
...
<div style={redBoldStyle}>C. Exercise Science Option Requirements (34-35 units)</div>
<ul style={list_style}>
</ul>
<div style={redBoldStyle}>1. Lower Division Required Courses (8-9 units)</div>
<ul style={list_style}>
<li>PHYS 100A General Physics I (3)</li>
<li>PHYS 100AL General Physics I Lab (1)</li>
<li>Select one of the following groups:</li>
<li>CHEM 101 General Chemistry I (3)</li>
<li>CHEM 101D Problem Solving in General Chemistry (1)</li>
<li>CHEM 101L General Chemistry Lab (1)</li>
<li>OR</li>
<li>CHEM 103 Introductory Chemistry I (3)</li>
<li>CHEM 103L Introductory Chemistry I Lab (1)</li>
<li>(CHEM 101/L is recommended for students planning a career in Physical Therapy.)</li>
</ul>
<div style={redBoldStyle}>2. Upper Division Required Courses (11 units)</div>
<ul style={list_style}>
...
<ul style={list_style}>
<li>Select 15 units with approval of advisor:</li>
<li>KIN 311/L Adapted Therapeutic Exercise Principles and Applications and Lab (2/1)</li>
<li>KIN 313/L Adapted and Therapeutic Aquatic Exercise and Lab (2/1)</li>
<li>KIN 336/L Applied Fitness Training and Lab (2/1)</li>
<li>KIN 337/L Introduction to Athletic Training and Lab (3/1)</li>
<li>KIN 402/L Computer Applications in Kinesiology and Lab (2/1)</li>
<li>KIN 415 Medical Aspects of Sport and Related Injuries (3)</li>
<li>KIN 436 Applied Exercise and Sports Physiology (3)</li>
<li>KIN 452/L Adapted Physical Activity for Children and Lab (2/1)</li>
...
<li>KIN 560 Clinical EKG and Exercise Stress Testing (3)</li>
...
<li>Total Units in the Major/Option: 75-82</li>
<li>General Education Units: 33</li>
<li>Additional Units: 5-12</li>
