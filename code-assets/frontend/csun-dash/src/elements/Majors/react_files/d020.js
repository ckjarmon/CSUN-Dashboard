                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Business Administration: Global Supply Chain Management</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>Business Majors</li>
...
<div style={redBoldStyle}>3. Breadth Courses: Communication Foundations (3 units)</div>
<ul style={list_style}>
<li>Select one of the following:</li>
<li>BLAW 308 Business Law II (3)</li>
<li>ENGL 306 Reporting Writing (3)</li>
<li>ENGL 407 Composition and the Professions (3)</li>
</ul>
<div style={redBoldStyle}>4. Required Global Supply Chain Management Courses (15 units)</div>
<ul style={list_style}>
...
<li>SCM 416/SOM 416 Supply Chain Management (3)</li>
<li>SCM 492 Supply Chain Management Strategy (3)</li>
</ul>
<div style={redBoldStyle}>5. Global Supply Chain Management Option Elective Courses (6 units)</div>
<ul style={list_style}>
<li>Select two of the following:</li>
<li>ACCT 470 Strategic Cost and Profit Management (3)</li>
<ul style={option_style}>
<li>BUS 491CS Small Business Consulting (3)***</li>
<li>or SOM 498 Field Assignments and Reports—Systems and Operations Management (3)</li>
</ul>
...
<li>SOM 464 Manufacturing Resource Planning (3)</li>
<li>SOM 467 Quality Management and Control (3)</li>
<li>SOM 468 Managing for Service Excellence (3)</li>
<li>***Senior Standing with a 3.0 or higher GPA. Other students will be considered with recommendation.</li>
</ul>
