                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%', outlineStyle: "solid", outlineColor: "red", borderRadius: "25px" }}>
                        <Box color="white" bgcolor="#000000" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Accountancy: Information Systems</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>Business Majors</li>
...
<div style={redBoldStyle}>5. Information Systems Option (12 units)</div>
<ul style={list_style}>
...
<li>Total Units in the Major/Option: 89-90</li>
<li>General Education Units: 27</li>
<li>Additional Units: 3-4</li>
