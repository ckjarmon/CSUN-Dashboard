                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Business Administration: Business Analytics</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>To enter the BSBA program with an option in Business Analytics, students must complete SOM 120 or MATH 140 with a grade of C or higher.</li>
...
<li>**The 4-unit MATH 140 course also satisfies this requirement. Either of them must be completed with a grade of C or better. MATH 140 is cross-listed with MATH 140BUS, MATH 140SCI and MATH 141/L.</li>
</ul>
...
<div style={redBoldStyle}>3. Upper Division Required Courses for the Option in Business Analytics (15 units)</div>
<ul style={list_style}>
<li>BANA 320 Predictive Analytics for Business (3)</li>
<li>BANA 410 Machine Learning for Business (3)</li>
<li>BANA 420 Prescriptive Analytics for Business (3)</li>
<li>IS 312 Systems and Technologies for Managers (3)</li>
<li>SOM 307 Data Analysis and Modeling for Business (3)***</li>
<li>***Students must complete SOM 307 with a grade of C or higher.</li>
</ul>
<div style={redBoldStyle}>4. Communication Course (3 units)</div>
<ul style={list_style}>
...
<div style={redBoldStyle}>5. Additional Courses (6 units)</div>
<ul style={list_style}>
<li>Select 6 additional units from the following (at least 3 units from the BANA courses):</li>
<li>BANA 310 Data Visualization for Business (3)</li>
<li>BANA 430 Text Mining and Analytics for Business (3)</li>
<li>BANA 440 Supply Chain Analytics (3)</li>
