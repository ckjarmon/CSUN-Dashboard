...
<div style={redBoldStyle}>3. Upper Division Required Courses for the Option in Systems and Operations Management (15 units)</div>
<ul style={list_style}>
...
<div style={redBoldStyle}>5. Select 6 additional units from the following:</div>
<ul style={list_style}>
<li>ECON 310 Price Theory and Applications (3)</li>
<li>SCM 447 Logistics and Transportation Management (3)</li>
<li>SOM 416 Supply Chain Management (3)</li>
<li>SOM 466 Project Management (3)</li>
<li>SOM 468 Managing for Service Excellence (3)</li>
<li>SOM 498 Field Assignments and Reports—Systems and Operations Management (3)</li>
</ul>
