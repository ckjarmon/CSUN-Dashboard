                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Information Systems: Computer Information Technology</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>Business Majors</li>
...
<li>Transfer students should be aware that no grade lower than a C will be accepted on transfer from another institution to satisfy department or David Nazarian College of Business and Economics requirements.</li>
...
<li>Check course descriptions for prerequisite courses. Prerequisites must be completed prior to enrolling in each course. All IS majors must earn a C or higher in all IS courses.</li>
</ul>
<div style={redBoldStyle}>1. Common Lower Division Business Core (27 units)</div>
<ul style={list_style}>
...
<li>*MATH 103 or a higher-level mathematics course (e.g., Calculus: MATH 150A or MATH 255A) must be completed with a grade of C or higher.</li>
...
<div style={redBoldStyle}>3. Required Information Systems Core Courses (19 units)</div>
<ul style={list_style}>
...
<div style={redBoldStyle}>4. Computer Information Technology (IS-CIT) Option (20 units)</div>
<ul style={list_style}>
<li>IS-CIT provides a focus of system administration electives for positions in DevOps and IT Infrastructure for business.</li>
...
<li>Select 3 units from the following elective courses:</li>
<li>CIT 425/L Information and Systems Security and Lab (2/1)</li>
<li>COMP 424 Computer System Security (3)</li>
<li>COMP 484/L Web Engineering I and Lab (2/1)</li>
<li>COMP 485 Human-Computer Interaction (3)</li>
<li>IS 498C Field Assignments and Reports Information Systems (3)</li>
<li>IS 499C Independent Study (3)</li>
</ul>
...
<li>Total Units in the Major/Option: 85</li>
