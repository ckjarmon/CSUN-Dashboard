                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Business Administration: Financial Planning</h2><div style={titleStyle}>Program Requirements</div><ul style={information_style}><li>Admission to the BSBA Option in Financial Planning</li>
<li>The BSBA option in Financial Planning is an impacted program. Students seeking an option in Financial Planning may initially declare an option in Pre-Finance while working to satisfy supplemental criteria, which requires completion of at least 60 units and a minimum cumulative GPA of 2.6. Students must qualify by the time they earn 90 units. Additionally, a grade of C or higher in FIN 303 is a prerequisite for all 400-level Finance (FIN) courses and selected 300-level Finance courses.</li>
...
<div style={redBoldStyle}>4. Financial Planning Option (18 units)</div>
<ul style={list_style}>
<li>Required Courses (12 units)</li>
<li>FIN 336 Principles of Risk Management and Insurance (3)</li>
<li>FIN 440 Retirement Planning and Employee Benefits (3)</li>
<li>FIN 442 Theory and Practice of Financial Planning (3)</li>
<li>FIN 446 Income Tax and Estate Planning (3)</li>
<li>Electives (6 units)</li>
<li>Select 6 units of Finance elective courses (does not include FIN 102, 338, 433 or 439; may not double count toward the Risk Management and Insurance option; FIN 302 can be double counted toward GE).</li>
