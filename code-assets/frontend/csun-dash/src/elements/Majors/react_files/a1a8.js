                ...
                <span className="font-link">
                    <div style={{ marginRight: '10%', marginLeft: '10%', marginTop: '50px', width: '80%' }}>
                        <Box color="black" bgcolor="#eeeeee" p={1}>
                            ...
                            <h2 style={{ color: '#E31C25', justifyContent: "center", textAlign: "center" }}>B.S., Kinesiology: Dance</h2><div style={titleStyle}>Program Requirements</div><div style={redBoldStyle}>A. Lower Division Prerequisite Courses (20-26 units)</div>
<ul style={list_style}>
</ul>
...
<li>BIOL 106L Biological Principles Lab (1)</li>
...
<li>Note: Completion of BIOL 211/212 or BIOL 383/L is prerequisite to enrollment in KIN 300. Completion of BIOL 281 or BIOL 383/L is prerequisite to enrollment in KIN 346/L. BIOL 382/L requires grades of C or better in BIOL 106/L and BIOL 107/L prerequisites.</li>
</ul>
...
<div style={redBoldStyle}>C. Dance Option Requirements (25 units)</div>
<ul style={list_style}>
<li>Select 25 units with advisor's approval. It is recommended that students take dance technique courses along with theoretical courses.</li>
<li>Theory Courses</li>
<li>KIN 314/L Creative Dance for Children and Lab (2/1)</li>
<li>KIN 315/L Analysis and Application of Multi-Cultural Dance Forms for Children and Adolescents and Lab (2/1)</li>
<li>KIN 316/L Choreographic Form and Lab (2/1)</li>
<li>KIN 317 Advanced Analysis of Dance Forms–Ballet, Jazz, Modern (3)</li>
<li>KIN 380/L Perspectives of Dance (2/1)</li>
...
<li>KIN 498WA-C Dance Concert Modes (1-3)</li>
<li>KIN 499A-C Independent Study (1-3)</li>
<li>Technique Courses</li>
<li>KIN 318 Intermediate Classical and Contemporary Ballet (3-3)</li>
<li>KIN 319 Intermediate Modern Dance (3-3)</li>
<li>KIN 321 Intermediate Contemporary Dance Forms (3-3)</li>
<li>KIN 418 Advanced Classical and Contemporary Ballet (3-3)</li>
<li>KIN 419 Advanced Modern Dance (3-3)</li>
<li>KIN 421 Advanced Contemporary Dance Forms (3-3)</li>
</ul>
...
<li>If taken, KIN 139A or KIN 144A satisfies 1 unit of C1 Arts; KIN 380/L satisfies upper division C1 Arts. Some Kinesiology Movement courses may satisfy 1-3 units of E Lifelong Learning. Refer to course descriptions for application in General Education.</li>
</ul>
<br></br><ul style={summary_style}>
<li>Total Units in the Major/Option: 66-72</li>
<li>General Education Units: 36</li>
<li>Additional Units: 12-18</li>
