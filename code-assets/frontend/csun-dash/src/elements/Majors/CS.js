                    ...
                    <Box color="black" bgcolor="#eeeeee" p={1}>
                        ...
                        <div style={{ marginLeft: '1%', padding: "" }}>
                            ...
                            <ul style={information_style}>
                                ...
                                <li>Carefully check course prerequisites as many courses in the major require grades of C or
                                    better in prerequisite courses.</li>
                                <li>No grade lower than a C will be accepted on transfer from another institution to satisfy
                                    Computer Science requirements. Where specific grade requirements are not specified, no CSUN grade lower than a C- will be accepted for courses required in the Computer Science program.</li>
                            </ul>
                            ...
                            <ul style={list_style}>
                                ...
                                <li style={subHeaderStyle}>Select one of the following:</li>
                                <ul style={option_style}>
                                    <li>COMP 482 Algorithm Design and Analysis (3)</li>
                                    <li>MATH 482 Combinatorial Algorithms (3)</li>
                                </ul>
                            ...
                            <ul style={information_style}>
                                ...
                                <li >18 units are satisfied by coursework in the major. Completion of the Computer Science major satisfies A3 Critical Thinking. 6 units of Physical Science or Life Science may be used to
                                    satisfy sections B1-3. MATH 150A satisfies Basic Skills B4 Mathematics/Quantitative Reasoning; COMP 310 satisfies B5 Scientific Inquiry and Quantitative Reasoning; and COMP 110/L satisfies E Lifelong Learning.</li>
                            </ul>
